...
import { appendWithoutOverwrite, comparableResearchPlans, isRunning, researchDate, researchPlanLabel, runLabel, shouldSendKey, type ResearchResult as ResearchResultData, type ResearchSummary } from '@/utils/expertResearch'
...
import type { ResearchExpert } from '@/utils/expertResearch'
...
<style scoped src="./leadership.css"></style>
