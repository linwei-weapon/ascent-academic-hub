<!-- 旧决策配置兼容组件：系统管理模块，沿用既有接口、治理操作与权限边界。 -->
<template>
  <div>
    ...
    <section class="sa-card">
      ...
      <el-form label-width="150px" class="llm-form">
        ...
        <el-form-item label="模型 model">
          <el-input v-model="llm.model" placeholder="如 qwen-plus / 私有化模型名" class="config-text-control" />
        </el-form-item>
        <el-form-item label="API Key">
          <el-input v-model="llmApiKey" type="password" show-password class="config-text-control"
          ...
          <el-form :label-width="230" class="skill-form">
            <el-form-item v-for="key in boundKeys(skill)" :key="key" :label="labelOf(key)">
              ...
              <el-select v-else-if="skill.config_bounds[key].type === 'list'"
                ...
                class="config-list-control" />
              <el-input v-else v-model="forms[skill.skill_id][key]" class="config-text-control" />
              <div class="def-line">
            ...
            <el-form-item label="变更原因">
              <el-input v-model="reasons[skill.skill_id]" maxlength="200" show-word-limit
                placeholder="说明为什么调整（必填，进入版本审计链）" class="config-change-reason" />
            </el-form-item>
            <el-form-item>
