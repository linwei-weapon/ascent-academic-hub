...
import { getAdviceExperts, getAdviceSession, getAdviceSessions, streamAdviceAsk } from '@/api/aiDecision/advice'
import { openDetailWindow, openEvidenceWindow } from '@/utils/decision'
...
// 发送当前问题并按原流式事件更新消息，保留会话、引用与失败反馈。
