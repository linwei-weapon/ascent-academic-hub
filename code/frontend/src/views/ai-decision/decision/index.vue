...
import { getDecisionBriefing, getDecisionSkills } from '@/api/aiDecision/briefing'
...
.fold-row:hover, .more-row:hover, .sec-row:hover {
  border-color: #c7d2fe;
  background: #fafbff;
}
