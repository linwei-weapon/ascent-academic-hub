...
IMPLEMENTED_METRICS = {
    ...
    "F-01": {
        "technical_kpi_id": "active_teaching_teacher_count",
        "status": "published",
        "data_source": "fact_lesson / dim_teacher / data_quality_issue",
        "grain": "教师×学期×授权范围",
        "update_cycle": "教学任务和数据质量状态同步后",
        "version": "3.0",
        "pages": [("/admin/faculty", "授课教师总数")],
    },
    "F-09": {
    ...
    "F-18": {
        "technical_kpi_id": "continuous_single_teacher_count",
        "status": "published",
