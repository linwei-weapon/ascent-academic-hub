...
本轮架构整理先读[项目架构与文档管理约定](文档/项目架构与文档管理约定.md)和 [AGENTS.md](AGENTS.md)。ARCH-01 已确定 Skill 适配方式；文档分类、模块索引、运行基线与代码整理在后续步骤实施。

| 想了解 | 看这份 |
|---|---|
| 系统做什么、给谁用、有哪些页面 | `文档/4-需求文档/01-需求说明.md` |
| 架构、技术选型、四层数据管线 | `文档/3-技术文档/02-技术方案.md` |
| 怎么装、怎么跑、常见报错 | `文档/5-部署方案/03-部署手册.md` |
| 登录、各页面怎么用、账号角色 | `文档/4-需求文档/公共需求/04-使用手册.md` |
| 改代码、加页面、加接口、改数据 | `文档/1-开发规范/05-二次开发指南.md` |
| 33 张表的字段含义 | `文档/3-技术文档/06-数据库表结构.md` |
| 初始化数据有哪些、ETL 怎么跑 | `文档/3-技术文档/07-数据初始化与ETL.md` |
