...
- **REQ-001**: 本次所有修改、新增页面、弹窗、抽屉、表格和图表必须遵循 `文档/2-样式规范/93-教学管理分析UE公共契约.md`，并继承现有系统的操作、视觉、配色、布局、权限、加载、空状态和返回规范。
...
| TASK-047 | 更新 `文档/4-需求文档/公共需求/本科教学分析与学业决策支持平台需求调研及指标口径确认书V2.md`，同步名称、公式、用途、来源、边界和核查路径。依赖 TASK-025～TASK-044。 | ✅ | 2026-07-27 |
| TASK-048 | 更新 `文档/4-需求文档/4.1-教学数据总览/94-教学数据总览UE深度走查与优化方案.md`、`文档/7-历史归档/实施与验收记录/80-原型最终集成验收与生产交接清单.md` 和 `文档/7-历史归档/实施与验收记录/82-产品终稿改造执行计划与检查表.md`。依赖 TASK-025～TASK-044。 | ✅ | 2026-07-27 |
...
- **DEP-001**: `文档/2-样式规范/93-教学管理分析UE公共契约.md`，所有新增交互和页面的强制基线。
...
- **FILE-021**: `文档/4-需求文档/4.1-教学数据总览/94-教学数据总览UE深度走查与优化方案.md`、`文档/7-历史归档/实施与验收记录/80-原型最终集成验收与生产交接清单.md`、`文档/7-历史归档/实施与验收记录/82-产品终稿改造执行计划与检查表.md`。
- **FILE-022**: `文档/4-需求文档/公共需求/本科教学分析与学业决策支持平台需求调研及指标口径确认书V2.md`。
...
- `文档/2-样式规范/93-教学管理分析UE公共契约.md`
- `文档/4-需求文档/4.1-教学数据总览/94-教学数据总览UE深度走查与优化方案.md`
- `文档/4-需求文档/公共需求/04-使用手册.md`
- `文档/1-开发规范/05-二次开发指南.md`
- `文档/7-历史归档/实施与验收记录/80-原型最终集成验收与生产交接清单.md`
- `文档/7-历史归档/实施与验收记录/82-产品终稿改造执行计划与检查表.md`
